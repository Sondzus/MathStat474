...
| **Week 14** | || 
| Hypothesis tests: The z-test and t-test for population mean.  | 10.4. |  [Homework 13](https://sondzus.github.io/MathStat474/HW13.html) is due week 15, day 1 [Monday! But  Wednesday will *not* be considered late.]. [Data in excel format](cell_phones.xls) and [Data for R](cell_phones.Rdata) |
| **Week 15** | ||
