...
> Posted on Thu 2/26. **Due: Thu Mar 5.** 


### Problem 1. 

Length (in days) of a randomly chosen human pregnancy is a normal random variable with $\mu=266$ and $\sigma=16$. 
...
In this problem we are practicing to compute the mean of a random variable. 
...
In this problem we are practicing to compute the variance of a random variable. 

A dealer’s profit, in units of $5000, on a new automobile is a random variable X having the density function given in the previous exercise.  Find the variance of X. 
